...
CREATE TABLE tbl_date(
	...
	ccol timestamp(9) , --9는 초단위 소수점 이하 9자리까지 표시
...
VALUES ('2022-10-11','2022-10-12');		--DATE, timestamp 차이가 없음

--내일 시험에서 timestamp 타입은 date 타입과 똑같이 코딩하면 됨
--날짜 형식은 문자열 'yyyy-mm-dd' 과 자동캐스팅이 됨
--date와 timestamp 모두 to_char 함수는 동일하게 사용함
